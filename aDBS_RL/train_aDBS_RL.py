...
if __name__ == "__main__":
    ...
    dir = os.path.join(MAIN_DIR, args.exp_name)
    ...
    # params_dict_train['dbs_action_bounds'] = [-25, 25]
    ...
    if args.agent == 'PPO':
        ...
        model = SAC("MlpPolicy", env,
                    verbose=0, tensorboard_log=tb_log)
    ...
    # 6. Save model
    msave_name = os.path.join(save_models_dir, f'{args.model_name}_{args.num_steps}_FIN.tf')
